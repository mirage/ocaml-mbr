...
(* OASIS_START *)
(* DO NOT EDIT (digest: a98fe5bf1596e4bbeaf291c4f1cf3cfb) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mbr-format";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "(\197\151\207+pt\017\161\169\221\026\136\tq\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
